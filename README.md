...
A [Simple Analytics](https://simpleanalytics.com/) source plugin for CloudQuery that loads data from Simple Analytics to any database, data warehouse or data lake supported by [CloudQuery](https://www.cloudquery.io/), such as PostgreSQL, BigQuery, Athena, and many more.
